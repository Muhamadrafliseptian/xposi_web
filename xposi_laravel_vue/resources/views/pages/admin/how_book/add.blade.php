...
@section('app_content')
    {{ Form::open(["url" => "admin/how_book", "enctype" => "multipart/form-data"]) }}
    <div class="row">
        </div>
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        {{ Form::text('icon_book', null, ['class' => 'form-control', 'placeholder' => 'Masukkan Icon']) }}
                    </div>
                    <div class="form-group">
                        {{ Form::label('title_book', 'Title') }}
                        {{ Form::text('title_book', null, ['class' => 'form-control', 'placeholder' => 'Masukkan Title']) }}
                    </div>
                    <div class="form-group">
                        {{ Form::label('description_book', 'Description') }}
                        {{ Form::textarea('description_book', null, ['class' => 'form-control', 'placeholder' => 'Masukkan Deskripsi']) }}
                    </div>
