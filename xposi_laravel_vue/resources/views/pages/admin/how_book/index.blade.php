            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <a href="{{ url('/admin/how_book/create') }}" class="btn btn-primary btn-rounded btn-sm">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example" class="table table-striped table-bordered first" style="width: 100%">
                            ...
                            <tbody>
                                @php $no=0 @endphp
                                @foreach ($data_book as $data)
                                    <tr>
                                        <td class="text-center">{{ ++$no }}.</td>
                                        <td>{{ $data->icon_book }}</td>
                                        <td>{{ $data->title_book }}</td>
                                        <td>{!! $data->description_book !!}</td>
                                        <td class="text-center">
                                            <a href="{{ url('/admin/how_book/' . encrypt($data->id) . '/edit') }}"
